...
@pytest.fixture(scope="session")
def golden_pose():
    """A synthetic pose with injected position noise and degraded per-keypoint
    confidence, standing in for a real (messier-than-synthetic) running clip.
    Generated by scripts/gen_test_fixture.py — entirely synthetic, no real
    video or person's movement data."""
    from gaitlab.core.schema import PoseSequence
    p = REPO / "tests" / "fixtures" / "golden_pose.json"
